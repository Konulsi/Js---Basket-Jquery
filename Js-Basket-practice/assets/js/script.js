...
cardBtns.forEach(btn => {
    btn.addEventListener("click", function (e) {              //burada buttona click edende bir-bir cardlari goture bilmek uchun
        ...
        let productPrice = parseInt(this.previousElementSibling.innerText);
        ...
        if (existProduct != undefined) {
            ...
            existProduct.price = productPrice * existProduct.count; // burada movcud olan productun qiymetini sayina uygun artimaq uchun her defe productduq oz deyerini sayina vururuq
        } else {
            products.push({
...
// document.querySelector("#test sapan").addEventListener("click",function(){
